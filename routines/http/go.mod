module github.com/mogud/snow/routines/http

go 1.21

require github.com/mogud/snow/core v0.0.0-00010101000000-000000000000
...
replace github.com/mogud/snow/core => ../../core
